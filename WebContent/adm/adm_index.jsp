...
<head>
	...
	<script type="text/javascript">
		...
		function logout(){
			if(confirm("您确定要退出本系统吗？")){
				window.location.href = "adm_login.jsp";
			}
		}
	...
	// 			alert("父类节点无法点击哦...");
		...
		function loadMenu(resourceType, treeObj){
            ...
            {"accessPath":"../selectHouse.do","checked":false,"delFlag":0,"parentID":3,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":7,"resourceName":"房源管理","resourceOrder":0,"resourceType":""},
            {"accessPath":"../selectUser.do","checked":false,"delFlag":0,"parentID":3,"resourceCode":"","resourceDesc":"","resourceGrade":3,"resourceID":8,"resourceName":"用户管理","resourceOrder":0,"resourceType":""},
...
<body onload="getDate01()">
			...
			<div id="top_op">
				<ul>
					<li>
						...
						<span>${sessionScope.adm.name }</span>
					</li>
					<li>
    ...
    <div id="main">
      	<iframe name="right" id="rightMain" src="<%=path %>/adm/adm_introduce.html" frameborder="no" scrolling="auto" width="100%" height="100%" allowtransparency="true"/>
    </div>
