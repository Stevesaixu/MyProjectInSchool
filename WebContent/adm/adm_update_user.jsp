...
<script type="text/javascript">
	...
	function checkFyFhSubmit(){
		...
		if(name!=""&&idCard!=""){
			...
			$("#submitForm").attr("action", "<%=path%>/updateUser.do").submit();
		...
		<div class="ui_content">
			...
			<input type="hidden" name="id" value="${sessionScope.user.id}"/>
				...
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="name" name="name"  class="ui_input_txt03" placeholder="请输入姓名" value="${sessionScope.user.name}"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="age" name="age"   class="ui_input_txt03" placeholder="请输入年龄" value="${sessionScope.user.age}"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="phone" name="phone"  class="ui_input_txt03" placeholder="请输入手机号" value="${sessionScope.user.phone}"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="email" name="email"  class="ui_input_txt03" placeholder="请输入邮箱" value="${sessionScope.user.email}"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" id="idCard" name="idCard"  class="ui_input_txt03" placeholder="请输入身份证号" value="${sessionScope.user.idCard}"/>
					</td>
				</tr>
